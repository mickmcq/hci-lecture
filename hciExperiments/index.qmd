...
```{r}
install.packages("pacman") # install a package manager
pacman::p_load(tidyverse, ggthemes) # use the package manager to install a large bundle of packages, the tidyverse, and another package, ggthemes
