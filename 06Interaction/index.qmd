...
![](fiSelfCheckout.jpg)
::: {.notes}
https://unsplash.com/photos/a-person-standing-in-a-room-with-computers-and-other-equipment-K5f-v0FFPCs
:::
...
- *Back to self-checkout: the barcode is an engineered, near-zero-ambiguity vocabulary, which is why the scan is fast and reliable; the delays live everywhere else*
...
- *Back to self-checkout: the bagging area is a control loop comparing expected weight to actual, and "unexpected item" is that loop reporting a mismatch it can't resolve on its own*
...
- *Back to self-checkout: a jammed lane has a brutal error-recovery cost, several forced turns and a wait for the attendant, exactly the metric an FSM would flag*
...
- *Back to self-checkout: "unexpected item in the bagging area" is a wide evaluation gulf; the machine knows exactly what is wrong and tells you almost nothing you can act on*
...
- *Back to self-checkout: for a shopper who can't lift items onto the scale, reach the scanner, or read the screen, the lane is unusable, and removing the cashier removed their fallback*
...
- *Back to self-checkout: shoppers who only ever self-check quietly lose the fluency of a full-service transaction, and there's no cashier left to fall back on*
...
- *Back to self-checkout: the store didn't remove checkout, it reallocated it to you and kept one attendant to supervise six lanes; that is a deliberate choice of type and level, not full automation*
...
- *Back to self-checkout: picking the self-checkout over the staffed lane is a bounded bet on which queue clears faster, and joining the first lane that looks good enough is satisficing, not impatience*
...
- *Back to self-checkout: it shifted labor onto customers and grew its own norms, from bagging etiquette to the loss-prevention arms race, none of it designed into the kiosk*
