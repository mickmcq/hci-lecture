...
::: {.notes}
[https://medium.com/remembering-health-care-before-the-aca/the-promise-failure-and-potential-of-healthcare-gov-e28a649d1ea3](https://medium.com/remembering-health-care-before-the-aca/the-promise-failure-and-potential-of-healthcare-gov-e28a649d1ea3)

[medium article on the launch failure of healthcare.gov]( https://medium.com/@bishr_tabbaa/small-is-beautiful-the-launch-failure-of-healthcare-gov-5e60f20eb967)
:::
...
::: {.callout-note}
**Fitts's Law** predicts the average time to acquire a target as a linear function of task difficulty:
...
- **It powers real systems:** key-target resizing in phone keyboards, and the layout-optimization algorithms that have challenged QWERTY are Fitts's Law applied.
...
## Activity 3: Transitions in Figma
...
*Every model in this deck assumes a human perceiving a display and choosing an action. An agent breaks that: perception, memory, and decision-making are split between person and machine. Does Fitts's Law even apply when nobody points? Whose mental model matters when the human never sees the interface? Push on what "human-centered" means here.*
