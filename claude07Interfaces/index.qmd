...
## The €1 filter
- Casiez et al. [@Casiez2012] found an elegant solution named, adorably, the €1 (one Euro) filter
...
- The book gives the remaining equations, but they are garbled in my copy, so trust the intuition over the typesetting
...
# Displays (Ch 25)
- A display is an output device: it transfers information from the system to the user
...
- Casiez and Roussel [@Casiez2011] reverse-engineered the gain curves in shipping operating systems and found large, surprising differences
...
- The words attached to tools and systems matter---Chapanis [@Chapanis1965] flagged this over 50 years ago
...
- The **vocabulary problem** (Furnas et al. [@Furnas1987]): ask two people to name a command and they agree with probability less than $0.2$
...
- Sparrow et al. [@Sparrow2011]: believing information had been saved made people remember it worse
...
- Hutchins et al. [@Hutchins1985]: $\text{directness} = \text{distance} + \text{engagement}$
...
- Frohlich [@Frohlich1993]: the empirical evidence is mixed; design and task together decide whether low distance pays off
...
- **Reality-based interaction** (Jacob et al. [@Jacob2008]) states positive aims via four human capabilities to exploit
...
- Weiser [@Weiser1991] imagined computing at three scales---*tabs, pads, boards*---matching the surfaces already in a room
...
- Holz and Baudisch [@Holz2010] found users aim using the finger's *perceived* outline and nail, from an imagined top-down view---a systematic bias software can correct
...
- Milgram and Kishino [@Milgram1994]: virtual and real form a *graded* relationship, not all-or-none
...
- Hollan and Stornetta [@Hollan1992] questioned the "belief in the efficacy of imitating face-to-face communication"
...
- Willett et al. [@Willett2022] borrowed "superpowers" from science fiction; Won et al. [@Won2015] let people control a third arm in VR within five minutes
