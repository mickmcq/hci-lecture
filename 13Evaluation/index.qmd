...
- **The field is a continuum, not a switch:** an evaluation can have more or fewer features of the real world
- **Four dials (McGrath):** people, activities, context, and technology can each be made more or less realistic
...
::: {.callout-note title="Pause and think"}
A banking app team wants to know how people navigate their newly launched site. They have logs from millions of sessions and a stack of one-star reviews. What can each source tell them that the other cannot, and which population is each one quietly missing?
:::
...
**Produce:** A one-page table with a row per dial stating your lab setting, your field setting, and what realism you gain, plus a threats-to-validity note; include one dial you deliberately left at "lab" and a written argument for why turning it up would be wrong.

**Time:** 25 min group work · 10 min share-out

**Debrief:** Which single dial, turned to field, would most change your findings, and why?

## Activity 2: Audit an AI product's field evaluation (~40 min)

**Task:** In groups of 3 to 4, pick a deployed AI product (a chatbot, a recommendation feed, an AI writing tool) and reconstruct how its makers likely evaluate it in the wild: logs, thumbs-up ratings, A/B tests, opt-in betas.

**Produce:** An annotated map of at least five real-world data sources they plausibly use, each tagged with the population it silently excludes and the threat to validity it carries; include one evaluation claim the company could honestly make and one it could not, with your reasoning.

**Time:** 28 min group work · 12 min share-out

**Debrief:** Which threat to validity is hardest to fix for an AI system that personalizes per user, and what would you do about it?
